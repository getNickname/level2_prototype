function animateSeparation() {
	...
	section.mouseenter(function(e){
		...
		loop = setInterval(function(){
			...
			leftImg.css({width:520 + (520 - xp) * 0.5, left: 0 + (520 - xp) * 0.1});
		    rightImg.css({width:520 + (xp - 520) * 0.5, right: 0 - (520 - xp) * 0.1});
		...
		leftImg.hoverFlow(e.type, {width: 520, left: 0}, duration, 'easeOutQuad');
		rightImg.hoverFlow(e.type, {width: 520, right: 0}, duration, 'easeOutQuad');
